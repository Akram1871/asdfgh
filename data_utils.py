...
pos_map = {'X':0, 'ADJ':1, 'ADP':2, 'ADV':3, 'AUX':4, 'CONJ':5, 'CCONJ':6, 'DET':7, 'INTJ':8, 'NOUN':9, 'NUM':10, 'PART':11, 'PRON':12, 'PROPN':13, 'PUNCT':14, 'SCONJ':15, 'SYM':16, 'VERB':17, 'SPACE':18}
dep_map = {'X':0, 'acl':1, 'acomp':2, 'advcl':3, 'advmod':4, 'agent':5, 'amod':6, 'appos':7, 'attr':8, 'aux':9, 'auxpass':10, 'case':11, 'cc':12, 'ccomp':13, 'compound':14, 'conj':15, 'cop':16,
           ...
           'ROOT':47, 'xcomp':48, 'nmod:npmod':49, 'nmod:poss':50, 'npadvmod':51,'acl:relcl':52,'cc:preconj':53,'mwe':54,'predet':55, 'det:predet':56, 'subtok':57, 'subj':58
           }
